...
The dataset is compiled from historical records of terrorist attacks, with the main dependent variable being the monthly count of terrorist attacks. This study initially identified a skewed number of casualties in May and August, but these were later attributed to outliers. To mitigate this, the analysis was refocused on the frequency of attacks, aiming to capture a more consistent pattern of terrorist activities. The research is grounded in a cross-sectional design, which analyzes different subjects within a singular temporal dimension.

3. Results

The Poisson regression analysis - the statistical model suited for count data - was applied to evaluate the monthly frequency of terrorist attacks. The model revealed that certain months showed a statistically significant increase in the number of attacks compared to January, the baseline month. Specifically, May, June, July, August, October, November, and December were found to have higher numbers of attacks, aligning with the hypothesized seasonal trend. The coefficients from the regression model indicated that these months had a higher expected count of attacks, with May and August (the beginning of the Summer season) having the most substantial increase.

As discussed in the preliminary analysis, there are a variety of hypotheses that could explain our results. The results show a trend where the number of distinct terrorist attacks increases through the spring, reaching an evident peak during the summer months. The small dip in the fall, particularly in August and September, followed by a rise again in October and November, suggests potential seasonal factors or operational cycles may influence terrorist activity, as our hypothesis stated.


This increase in the spring and summer months pattern could be related to various factors:
...
Although this notable trend is observable in the data, it’s definitely only a starting point for understanding the complexities behind terrorist activities.
